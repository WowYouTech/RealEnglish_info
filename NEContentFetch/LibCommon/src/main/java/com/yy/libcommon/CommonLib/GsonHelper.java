package com.yy.libcommon.CommonLib;
...
//    ArrayList<AccountDetailPage>  list =
//            GsonHelper.objectListFromString(cachedAccount.detailPagesData,
//                    new TypeToken<ArrayList<AccountDetailPage>>(){}.getType());
