...
public class YesNoDialog extends BaseDialog{
    ...
    public void init(){
        ...
        getDialog().getWindow().setLayout((int)getResources().getDimension(R.dimen.default_dialog_width),
    ...
    private void setInitialValues(){
        ...
        if (mAcceptButtonText != null){
            ...
            mAcceptButton.setText(getString(R.string.ok));
        }

        if (mDeclineButtonText != null){
            mDeclineButton.setText(mDeclineButtonText);
        } else {
            mDeclineButton.setText(getString(R.string.cancel));
        }
    }
